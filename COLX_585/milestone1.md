...
You should finish everything discussed above by 11:59pm Saturday, April 3. You will get an automatic extension until Sunday, April 4 at 12/noon. (You don't need to ask for that extension. Please go ahead and use it if you need it). Submissions after Sunday, April 4 12/noon, will be penalized by 5% if receieved after 12/noon. Another 5% applies for each additional day, up to total assignment weight. 
